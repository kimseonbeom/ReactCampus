...
import { CatTitle, FlexDiv } from '../../commons/ListComponents'
...
import { Picture, PictureContainer, PictureModifyBtn, Table, TableOverView, TableText, TableTitle, TitleText, Wrap } from './Mypage'
  ...
  return (
   ...
   <Container style={{backgroundColor:'#fff',display:'flex', justifyContent:'space-between', alignItems:'center'}}>
        ...
        <PictureContainer>
            <div>
            <Picture>
                <img src={user1} style={{width:'100%', height:'100%', objectFit:'cover', borderRadius:'50%',display:'block'}}/>
                <PictureModifyBtn>
