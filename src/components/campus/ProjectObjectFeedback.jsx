...
import { Head, RegistTextarea, Title, Wrap } from './LectureOnlineRegist'
import { ContentBox, HeadText } from './HomeWrapper'
import { Hr } from './SideMenu'
import Cancle from './img/Cancle.png'
import Toast from './Toast'
import useModalStore, { useProjectFeedbackModalStore } from './modalStore'
import styled from 'styled-components'
import right from './img/right.png'
import { Table, TableOverView, TableText, TableTitle, TitleText } from './Mypage'
import { TableTitles, TitleTexts } from './LecturePlanDetail'
